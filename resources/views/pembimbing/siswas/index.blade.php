                ...
                <tbody>
                    @foreach ($siswas as $siswa)
                        <tr>
                            ...
                            <td>
                                {{ $jurusanMap[strtolower($siswa->siswa->jurusan)] ?? strtoupper($siswa->siswa->jurusan) }}
                            </td>
                            <td>
                                {{ $siswa->industri->nama ?? 'Tidak Ditempatkan' }}
                            </td>
                            <td>
                                <a href="{{ route('pembimbing.siswas.show', $siswa) }}"
