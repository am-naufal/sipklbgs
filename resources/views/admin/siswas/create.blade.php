...
@section('content')
    <div class="container mx-auto p-4">
        ...
        <form action="{{ route('admin.siswas.store') }}" method="POST" class="space-y-4">
            @csrf
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select name="jurusan" id="jurusan" class="border rounded w-full p-2">
                        ...
                        <option value="tb" @selected(old('jurusan') == 'tb')>Teknik Boga</option>
                        <option value="mm" @selected(old('jurusan') == 'mm')>Multimedia</option>
                        <option value="aphp" @selected(old('jurusan') == 'aphp')>Agribisnis Pengolahan Hasil Pertanian</option>
                    </select>
                    @error('jurusan')
                        <div class="text-red-500 text-sm">{{ $message }}</div>
                    @enderror
                ...
                <div>
                    ...
                    <select name="status_pkl" id="status_pkl" class="border rounded w-full p-2">
                        <option value="belum_mulai" @selected(old('status_pkl') == 'belum_mulai')>Belum Mulai</option>
                        <option value="sedang_berjalan" @selected(old('status_pkl') == 'sedang_berjalan')>Sedang Berjalan</option>
