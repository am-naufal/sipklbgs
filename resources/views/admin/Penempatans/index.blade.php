...
@section('content')
    <div class="container mx-auto p-4">
        ...
        <a href="{{ route('admin.penempatans.create') }}" class="btn btn-primary text-white mb-4">
            <i class="fas fa-plus mr-1"></i> Tambah Penempatan
        </a>
                ...
                <tbody>
                    @foreach ($penempatans as $penempatan)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.penempatans.show', $penempatan) }}"
                                    class="btn btn-sm btn-info text-white" title="Lihat">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('admin.penempatans.edit', $penempatan) }}"
                                    class="btn btn-sm btn-warning text-white" title="Edit">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <form action="{{ route('admin.penempatans.destroy', $penempatan) }}" method="POST"
