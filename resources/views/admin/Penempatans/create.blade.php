...
@section('content')
    <div class="container mt-4">
        <div class="mb-4">
            <h1 class="h3">Form Tambah Penempatan</h1>
            <p class="text-muted">Lengkapi data penempatan siswa ke industri beserta pembimbing dan jadwalnya.</p>
        </div>
                ...
                <form action="{{ route('admin.penempatans.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="industri_id" id="industri_id"
                            class="form-control @error('industri_id') is-invalid @enderror" required>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="keterangan" id="keterangan" class="form-control @error('keterangan') is-invalid @enderror"
                            placeholder="Contoh: Penempatan kelompok A, shift pagi.">{{ old('keterangan') }}</textarea>
                        @error('keterangan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="d-flex justify-content-end">
                        <a href="{{ route('admin.penempatans.index') }}" class="btn btn-secondary me-2">
